...
class ChessGame:
    ...
    def current_state(self):
        ...
        Return: BoardState representing the current board state (or None)
        '''
    ...
    def get_result(self):
        ...
        if board.is_checkmate():
            ...
            return GameResult("Draw", "fifty move rule", .5)
        elif board.is_stalemate():
            # Draw due to stalemate
            return GameResult("Draw", "stalemate", .5)
        elif self.threefold_repetition():
            # Draw due to threefold repetition
            return GameResult("Draw", "threefold repetition", .5)
        elif board.insufficient_material():
            # Draw due to insufficient material
            return GameResult("Draw", "insufficient material", .5)
        else:
            # Game is not over
            return None
...
class GameResult:
    ...
    '''
    def __init__(self, result_type, reason, white_score):
        '''
