...
class NotationWidget(ttk.Frame):
    ...
    def __init__(self, root):
        ...
        self._scrollable_frame.columnconfigure(1, minsize=NOTATION_WIDTH, pad=2)   # white moves
    ...
    def add_move(self, move_num: int, notation: str, color: bool):
        ...
        ttk.Label(self._scrollable_frame, text=notation).grid(row=self._row, column=col,
                                                              sticky=tkinter.W)
    ...
    def _delete_widgets(self, row, col):
        '''
    ...
    def _set_up_frame(self):
        ...
        self._scrollable_frame.bind('<Configure>', lambda e: self._canvas.configure(
                scrollregion=self._canvas.bbox("all")
        ))
        self._canvas.create_window((0, 0), window=self._scrollable_frame, anchor=tkinter.NW)
